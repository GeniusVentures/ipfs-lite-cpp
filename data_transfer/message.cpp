...
namespace sgns::data_transfer
{
    ...
    {
        return DataTransferMessage{ /*.is_request = */ true,
                                    /*.request = */
                                    DataTransferRequest{ /*.base_cid = */ std::move( base_cid ),
                                                         /*.is_cancel = */ false,
                                                         /*.pid = */ {},
                                                         /*.is_part = */ false,
                                                         /*.is_pull = */ is_pull,
    ...
    {
        return DataTransferMessage{ /*.is_request = */ false,
                                    /*.request = boost::none,*/
                                    DataTransferRequest{},
                                    /*.response = */
                                    DataTransferResponse{ /*.is_accepted = */ is_accepted,
                                                          /*.transfer_id = */ transfer_id } };
    }
