...
namespace sgns::data_transfer
{
   ...
   */
    ...
    public:
        ...
        virtual IPFS::outcome::result<void> receiveRequest( const PeerId              &initiator,
                                                            const DataTransferRequest &request ) = 0;

        virtual IPFS::outcome::result<void> receiveResponse( const PeerId               &sender,
    ...
    private:
        std::map<std::string, std::shared_ptr<RequestValidator>> voucher_validators_;
    };
