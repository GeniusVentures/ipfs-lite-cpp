...
namespace sgns::crypto
{
    ...
    IPFSHasher::Multihash IPFSHasher::calculate( HashType hash_type, gsl::span<const uint8_t> buffer )
    {
    ...
    IPFSHasher::Multihash IPFSHasher::sha2_256( gsl::span<const uint8_t> buffer )
    {
        ...
        BOOST_ASSERT_MSG( digest, "sgns::crypto::IPFSHasher - failed to generate sha2-256 hash value" );

        auto multi_hash = Multihash::create( HashType::sha256, digest.value() );
        BOOST_ASSERT_MSG( multi_hash.has_value(), "sgns::crypto::IPFSHasher - failed to create sha2-256 hash" );
    ...
    IPFSHasher::Multihash IPFSHasher::blake2b_256( gsl::span<const uint8_t> buffer )
    {
        ...
        BOOST_ASSERT_MSG( multi_hash.has_value(), "sgns::crypto::IPFSHasher - failed to create blake2b_256 hash" );
        return multi_hash.value();
    }
}
