...
namespace sgns::common
{
    ...
    IPFS::outcome::result<CID> commitmentToCID( gsl::span<const uint8_t> commitment, FilecoinMultihashCode code )
    {
        ...
        BOOST_OUTCOME_TRY( auto mh, Multihash::create( static_cast<HashType>( code ), commitment ) );

        return CID( libp2p::multi::ContentIdentifier::Version::V1, kFilecoinCodecType, mh );
    }
    ...
    {
        BOOST_OUTCOME_TRY( auto result, CIDToCommitment( cid ) );
