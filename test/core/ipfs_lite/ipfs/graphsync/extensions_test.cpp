...
TEST( GraphsyncExtensions, ResponseMetadataWrongName )
{
    ...
    Extension extension{ /*.name = */ "wrong_name" };
    EXPECT_OUTCOME_ERROR( Error::MESSAGE_PARSE_ERROR, decodeResponseMetadata( extension ) );
}
...
TEST( GraphsyncExtensions, DontSendCidsWrongName )
{
    // Extension extension{.name = "wrong_name"};
    Extension extension{ /*.name = */ "wrong_name" };
    EXPECT_OUTCOME_ERROR( Error::MESSAGE_PARSE_ERROR, decodeDontSendCids( extension ) );
}
