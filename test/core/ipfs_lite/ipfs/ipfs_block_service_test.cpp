...
protected:
    ...
    BlockTestImpl sample_block_{ { 4, 8, 15, 16, 23, 42 } }; /**< Sample block with pre-defined data */
};
...
TEST_F( BlockServiceTest, StoreBlockSuccess )
{
    ...
    EXPECT_OUTCOME_TRUE( block_content, block_service_.get( sample_block_.cid ) )
