...
#define EXPECT_OUTCOME_TRUE_2( val, expr ) EXPECT_OUTCOME_TRUE_3( _UNIQUE_NAME( _r ), val, expr )

#define EXPECT_OUTCOME_TRUE_1( expr ) EXPECT_OUTCOME_TRUE_void( _UNIQUE_NAME( _v ), expr )

#define EXPECT_OUTCOME_FALSE_3( var, val, expr ) EXPECT_OUTCOME_FALSE_name( var, val, expr )

#define EXPECT_OUTCOME_FALSE_2( val, expr ) EXPECT_OUTCOME_FALSE_3( _UNIQUE_NAME( _r ), val, expr )

#define EXPECT_OUTCOME_FALSE_1( expr ) EXPECT_OUTCOME_FALSE_void( _UNIQUE_NAME( _v ), expr )
 ...
 */
#define EXPECT_OUTCOME_TRUE( val, expr ) EXPECT_OUTCOME_TRUE_name( _UNIQUE_NAME( _r ), val, expr )

#define EXPECT_OUTCOME_FALSE( val, expr ) EXPECT_OUTCOME_FALSE_name( _UNIQUE_NAME( _f ), val, expr )
 ...
 */
#define EXPECT_OUTCOME_TRUE_MSG_1( expr, msg ) EXPECT_OUTCOME_TRUE_MSG_void( _UNIQUE_NAME( _v ), expr, msg )
 ...
 * and appends custom error message specified in msg.
 */
#define EXPECT_OUTCOME_TRUE_MSG( val, expr, msg ) EXPECT_OUTCOME_TRUE_MSG_name( _UNIQUE_NAME( _r ), val, expr, msg )
...
#define EXPECT_OUTCOME_RAISE( ecode, statement ) EXPECT_OUTCOME_RAISE_3( _UNIQUE_NAME( _e ), ecode, statement )
...
#define EXPECT_OUTCOME_ERROR( ecode, expr ) EXPECT_OUTCOME_ERROR_3( _UNIQUE_NAME( _e ), ecode, expr )
