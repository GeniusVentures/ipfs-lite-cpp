   ...
   */
     ...
     */
        ...
        static IPLDBlock create( const T &entity )
        {
            ...
            return IPLDBlock{ CID{ params.cid_version, params.content_type, multihash }, bytes };
        }
     ...
     */
        ...
        {
            return { IPLDType::Version::V1, IPLDType::Content::DAG_CBOR, IPLDType::Hash::blake2b_256 };
        }
