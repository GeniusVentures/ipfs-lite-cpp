...
#ifndef CPP_IPFS_LITE_GRAPHSYNC_HPP
#define CPP_IPFS_LITE_GRAPHSYNC_HPP
...
namespace sgns::ipfs_lite::ipfs::graphsync
{
    ...
    public:
        ...
        using RequestProgressCallback =
            std::function<void( ResponseStatusCode code, std::vector<Extension> extensions )>;
        ...
        virtual Subscription makeRequest( const libp2p::peer::PeerId                               &peer,
...
#endif // CPP_IPFS_LITE_GRAPHSYNC_HPP
