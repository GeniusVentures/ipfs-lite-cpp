...
namespace sgns::ipfs_lite::ipfs::graphsync
{
    ...
    public:
        ...
        Subscription newRejectedRequest( Graphsync::RequestProgressCallback callback );

        /// Forwards responses to requests callbacks
        /// \param request_id request ID
        /// \param status response status
        /// \param extensions - data for protocol extensions
        void onResponse( RequestId request_id, ResponseStatusCode status, std::vector<Extension> extensions );
