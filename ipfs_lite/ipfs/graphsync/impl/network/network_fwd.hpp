...
namespace sgns::ipfs_lite::ipfs::graphsync
{
    ...
    public:
        ...
        virtual void onRemoteRequest( const PeerId &from, Message::Request request ) = 0;
    ...
    public:
        ...
        virtual void onReaderEvent( const StreamPtr &stream, IPFS::outcome::result<Message> message ) = 0;

        /// Called on message is written asynchronously
        /// \param stream libp2p stream
        /// \param message Write result
        virtual void onWriterEvent( const StreamPtr &stream, IPFS::outcome::result<void> result ) = 0;
    };
