...
namespace sgns::ipfs_lite::ipfs::graphsync
{
    ...
    class Network : public std::enable_shared_from_this<Network>, public PeerToNetworkFeedback
    {
    public:
        /// Ctor.
        ...
        bool addBlockToResponse( const PeerId &peer, RequestId request_id, const CID &cid, const common::Buffer &data );
    ...
    private:
        ...
        /// \param request_id request ID
        /// \param status status code
        void asyncFeedback( const PeerId &peer, RequestId request_id, ResponseStatusCode status );
