...
namespace sgns::ipfs_lite::ipfs::graphsync
{
    ...
    class PeerContext : public std::enable_shared_from_this<PeerContext>, public EndpointToPeerFeedback
    {
    public:
        ...
        void setOutboundAddress( boost::optional<std::vector<libp2p::multi::Multiaddress>> connect_to );
        ...
        bool addBlockToResponse( RequestId request_id, const CID &cid, const common::Buffer &data );
        ...
        void sendResponse( RequestId request_id, ResponseStatusCode status, const std::vector<Extension> &extensions );
    ...
    private:
        ...
        void onReaderEvent( const StreamPtr &stream, IPFS::outcome::result<Message> message ) override;

        /// Feedback from endpoints on async write operations
        /// \param stream libp2p stream
        /// \param message Write result
        void onWriterEvent( const StreamPtr &stream, IPFS::outcome::result<void> result ) override;
