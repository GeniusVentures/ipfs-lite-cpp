...
namespace sgns::ipfs_lite::ipfs::merkledag
{
     ...
     */
        ...
        IPFS::outcome::result<std::shared_ptr<IPLDNode>> getNode( const CID &cid ) const override;
        ...
        IPFS::outcome::result<std::shared_ptr<Leaf>> fetchGraph( const CID &cid ) const override;
