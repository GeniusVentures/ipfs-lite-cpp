#ifndef CPP_IPFS_LITE_CORE_CODEC_CBOR_CBOR_ERRORS_HPP
#define CPP_IPFS_LITE_CORE_CODEC_CBOR_CBOR_ERRORS_HPP
...
#endif  // CPP_IPFS_LITE_CORE_CODEC_CBOR_CBOR_ERRORS_HPP
